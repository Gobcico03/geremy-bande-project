import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, shallowRef, toRef, onServerPrefetch, isRef, computed, toValue, reactive, defineComponent, unref, useSSRContext, h, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, createApp, effectScope, getCurrentScope, onErrorCaptured, createVNode, resolveDynamicComponent, isReadonly, withCtx, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as hash, p as withoutTrailingSlash, q as withLeadingSlash, r as defu, t as sanitizeStatusCode, v as parseURL, x as encodeParam, y as withBase, h as createError$1, z as createHooks, A as klona, B as parse, C as getRequestHeader, D as destr, E as isEqual, F as setCookie, G as getCookie, H as deleteCookie, I as encodePath, J as toRouteMatcher, K as createRouter$1 } from '../runtime.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { CapoPlugin, getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import MiniSearch from 'minisearch';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-GkN7sgDZ.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-slug",
    path: "/blog/:slug(.*)*",
    component: () => import('./_...slug_-C3ull_1I.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-CffkTfuN.mjs').then((m) => m.default || m)
  },
  {
    name: "collection-slug",
    path: "/collection/:slug(.*)*",
    component: () => import('./_...slug_-DglqIJyY.mjs').then((m) => m.default || m)
  },
  {
    name: "collection",
    path: "/collection",
    component: () => import('./index-Bk0yLq65.mjs').then((m) => m.default || m)
  },
  {
    name: "dash",
    path: "/dash",
    component: () => import('./dash-FYboJVFT.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DdiFER4b.mjs').then((m) => m.default || m)
  },
  {
    name: "page-slug",
    path: "/page/:slug(.*)*",
    component: () => import('./_...slug_-CHdQ158j.mjs').then((m) => m.default || m)
  },
  {
    name: "page",
    path: "/page",
    component: () => import('./index-5xXfx56o.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-CQullS9y.mjs').then((m) => m.default || m)
  },
  {
    name: "tags-slug",
    path: "/tags/:slug()",
    component: () => import('./_slug_-kqLNyIDd.mjs').then((m) => m.default || m)
  }
];
...
const LazyBlogNavigation = defineAsyncComponent(() => import('./BlogNavigation-CmL5SnJI.mjs').then((r) => r["default"] || r.default || r));
const LazyFolderContent = defineAsyncComponent(() => import('./FolderContent-CVeaQfcD.mjs').then((r) => r["default"] || r.default || r));
const LazyFolderNavigation = defineAsyncComponent(() => import('./FolderNavigation-DaONK-q3.mjs').then((r) => r["default"] || r.default || r));
const LazyHomepageImage = defineAsyncComponent(() => import('./HomepageImage-CsV4prq0.mjs').then((r) => r["default"] || r.default || r));
const LazyImageGallery = defineAsyncComponent(() => import('./ImageGallery-DMk-4ZeO.mjs').then((r) => r["default"] || r.default || r));
const LazyMainNavigation = defineAsyncComponent(() => import('./MainNavigation-ClPXfOiC.mjs').then((r) => r["default"] || r.default || r));
const LazyPageNavigation = defineAsyncComponent(() => import('./PageNavigation-CDSxhyDS.mjs').then((r) => r["default"] || r.default || r));
const LazyPromotedContent = defineAsyncComponent(() => import('./PromotedContent-D8-0mDUT.mjs').then((r) => r["default"] || r.default || r));
const LazyRelatedPages = defineAsyncComponent(() => import('./RelatedPages-D1vzgiYy.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsBlogNavigation = defineAsyncComponent(() => import('./BlogNavigation-Do091KxT.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsFolderNavigation = defineAsyncComponent(() => import('./FolderNavigation-CwKPdbqN.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsMainNavigation = defineAsyncComponent(() => import('./MainNavigation-CqITBoqP.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsPageNavigation = defineAsyncComponent(() => import('./PageNavigation-Xc5U9Dy-.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BBhwb_do.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-e9cjjcM7.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-H7zlg8bK.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-BDMNK7Ki.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DSAOASLH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BwLYqCzW.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-B_8UYRHq.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BCe7-UHp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-Cw9DZSdG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-C74m8DnN.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-Ccxpjstx.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BWo7HwOT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DLZr5Ojv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BvFMgkd3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-Dl0vZk5a.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BntSZPZd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-K9I0JcMJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-B92pmrk1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BfX0oA3E.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BiBO8j61.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BEVq9Iki.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DOn50GOM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CcbgZ05I.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-DRLValj-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CZBXg1Q8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-DPbtWowY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-D1Zf4j7U.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-78lMxueE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-4A8HUXCn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-aeWCmP0D.mjs').then((r) => r["default"] || r.default || r));
...
const ipxRuntime$uh1yLLph6r = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$uh1yLLph6r, defaults: {} }
};
const useImage = () => {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Djo3GtoC.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-Djo3GtoC.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./default-bR0fXOgk.mjs').then((m) => m.default || m),
  page: () => import('./page-BfzNSKgn.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BTeoruTo.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CVki8hwL.mjs').then((r) => r.default || r));
...
export { apply as A, withoutKeys as B, withKeys as C, createQuery as D, _export_sfc as _, useRuntimeConfig as a, useContent as b, useRequestEvent as c, __nuxt_component_0 as d, entry$1 as default, useAsyncData as e, useRouter as f, navigateTo as g, useNuxtApp as h, useRoute as i, useContentPreview as j, useFetch as k, useState as l, useImage as m, nuxtLinkDefaults as n, prerenderStaticImages as o, parseSize as p, queryContent as q, resolveRouteObject as r, _sfc_main$3 as s, fetchContentNavigation as t, useHead as u, get as v, assertArray as w, ensureArray as x, omit as y, sortList as z };
